...
<body class="bg-white text-gray-900 antialiased">
    ...
    <main>
        ...
        <section class="py-20 px-4 sm:px-6 lg:px-8"><div class="max-w-5xl mx-auto text-center"><h2 class="text-3xl font-bold mb-4">Related ${city.city} SEO pages</h2><p class="text-lg text-gray-600 mb-8">These pages connect local demand with Chinese restaurant AI phone ordering, POS integration, and specific POS systems.</p><div class="flex flex-wrap justify-center gap-4 text-sm font-medium"><a href="/chinese-restaurant-ai-phone-ordering/" class="text-primary-600 hover:text-primary-700">Chinese restaurant AI phone ordering</a><a href="/restaurant-pos-phone-order-integration/" class="text-primary-600 hover:text-primary-700">Restaurant POS phone order integration</a><a href="/pos/39-miles-ai-phone-ordering/" class="text-primary-600 hover:text-primary-700">39 Miles AI phone ordering</a><a href="/pos/menusifu-ai-phone-ordering/" class="text-primary-600 hover:text-primary-700">MenuSifu AI phone ordering</a></div></div></section>
...
<body class="bg-white text-gray-900 antialiased">
    ...
    <main>
        ...
        <section class="py-20 px-4 sm:px-6 lg:px-8"><div class="max-w-5xl mx-auto text-center"><h2 class="text-3xl font-bold mb-4">${city.zhCity}相关 SEO 页面</h2><p class="text-lg text-gray-600 mb-8">这些页面把本地搜索需求连接到中餐馆 AI 电话接单、POS 对接和具体 POS 系统。</p><div class="flex flex-wrap justify-center gap-4 text-sm font-medium"><a href="/zh/chinese-restaurant-ai-phone-ordering/" class="text-primary-600 hover:text-primary-700">中餐馆 AI 电话接单</a><a href="/zh/restaurant-pos-phone-order-integration/" class="text-primary-600 hover:text-primary-700">餐厅 POS 电话订单对接</a><a href="/zh/pos/39-miles-ai-phone-ordering/" class="text-primary-600 hover:text-primary-700">39 Miles AI 电话接单</a><a href="/zh/pos/menusifu-ai-phone-ordering/" class="text-primary-600 hover:text-primary-700">MenuSifu AI 电话接单</a></div></div></section>
