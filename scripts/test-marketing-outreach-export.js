...
assert.match(authorityCommandCenter, /15-action projected score after ordered completion: 66\/100/);
assert.match(authorityCommandCenter, /15-action projected delta: \+60/);
...
assert.match(authorityCommandCenter, /## 15-Submission Milestone Queue/);
assert.match(authorityCommandCenter, /\| 15 \| Toast restaurant consultants \| 88 \| POS-specific outreach \| Partner reply, referral-page URL, submitted form confirmation, or sent-message URL\. \|/);
