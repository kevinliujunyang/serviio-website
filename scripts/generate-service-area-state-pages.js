...
<body class="bg-white text-gray-900 antialiased">
    ...
    <main>
        ...
        <section class="py-20 px-4 sm:px-6 lg:px-8"><div class="max-w-5xl mx-auto text-center"><h2 class="text-3xl font-bold mb-4">${state.zhName}相关搜索需求</h2><p class="text-lg text-gray-600 mb-8">本页覆盖${state.zhName}餐厅 AI 接电话、${state.zhName}中餐外卖 AI 接单、${state.zhName}餐厅 POS 电话订单对接等本地搜索组合。</p><div class="flex flex-wrap justify-center gap-4 text-sm font-medium"><a href="/zh/chinese-restaurant-pos-integration/" class="text-primary-600 hover:text-primary-700">中餐馆 POS 对接</a><a href="/zh/ai-phone-answering-for-chinese-restaurants/" class="text-primary-600 hover:text-primary-700">中餐馆 AI 电话接听</a><a href="/zh/pos/39-miles-ai-phone-ordering/" class="text-primary-600 hover:text-primary-700">39 Miles AI 电话接单</a><a href="/zh/pos/menusifu-ai-phone-ordering/" class="text-primary-600 hover:text-primary-700">MenuSifu AI 电话接单</a></div></div></section>
...
function updateIndexingScript() {
  ...
  if (js.includes(marker)) {
    ...
    js = js.replace("  '/pos/mealkeyway-ai-phone-ordering/',", `  '/pos/mealkeyway-ai-phone-ordering/',\n  '/service-areas/',\n${additions}`);
  }
