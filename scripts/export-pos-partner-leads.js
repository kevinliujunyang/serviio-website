...
function buildPosPartnerRows(scoredRows) {
  return scoredRows
    ...
    .map((row) => ({
      ...
      pos_partner_sharing_consent: row.pos_partner_sharing_consent,
      pos_partner_consent: row.pos_partner_consent,
      pos_purchase_timeline: row.pos_purchase_timeline,
      pos_purchase_timeline_urgency: row.pos_purchase_timeline_urgency,
      recommended_pos_partner_targets: row.recommended_pos_partner_targets,
